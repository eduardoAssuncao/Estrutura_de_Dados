...
public class ArvoreAVL {
    ...
    public  ArvoreAVL rotacaoDuplaDireita(){
        ...
        filhoDir.setEsquerda(noInserido); // 17
        filhoDoFilho.setDireita(filhoDir); // 20
        this.setDireita(filhoDoFilho); //15

        // parte 2: tornar o filho à direita a nova raiz
        ArvoreAVL novoFilhoDireita = this.getDireita(); // 15
    ...
    public String toString(){
        return "["+this.ele.getValor()+"]" + "(Balanceamento: "+this.bal+")";
    }
}
